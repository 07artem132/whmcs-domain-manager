...
<fieldset>
    ...
    <form role="form" id="settings" method="post" class="label-form">
        <div class="row">
            ...
            <div class="col-md-3">
                <div>
                    <input type="text" class="form-control" name="zone_filter" id="zone_filter" value="*" required>
                </div>
            </div>
            <div class="col-md-6">
            ...
            <div class="col-md-3">
                <div>
                    <input type="number" class="form-control" name="zone_limit" id="zone_limit" value="-1" required>
                </div>
            </div>
            <div class="col-md-6">
            ...
            <div class="col-md-3">
                <div>
                    <input type="number" class="form-control" name="record_limit" id="record_limit" value="-1" required>
                </div>
            </div>
            <div class="col-md-6">
        ...
        <div class="row">
            ...
            <div class="col-md-3">
                <div>
                    <input type="text" class="form-control" name="TXT" id="TXT" value="-1" required>
                </div>
            </div>
            <div class="col-md-6">
            ...
            <div class="col-md-3">
                <div>
                    <input type="text" class="form-control" name="NS" id="NS" value="-1" required>
                </div>
            </div>
            <div class="col-md-6">
            ...
            <div class="col-md-3">
                <div>
                    <input type="text" class="form-control" name="DNAME" id="DNAME" value="-1" required>
                </div>
            </div>
            <div class="col-md-6">
            ...
            <div class="col-md-3">
                <div>
                    <input type="text" class="form-control" name="SRV" id="SRV" value="-1" required>
                </div>
            </div>
            <div class="col-md-6">
            ...
            <div class="col-md-3">
                <div>
                    <input type="text" class="form-control" name="MX" id="MX" value="-1" required>
                </div>
            </div>
            <div class="col-md-6">
            ...
            <div class="col-md-3">
                <div>
                    <input type="text" class="form-control" name="CNAME" id="CNAME" value="-1" required>
                </div>
            </div>
            <div class="col-md-6">
            ...
            <div class="col-md-3">
                <div>
                    <input type="text" class="form-control" name="PTR" id="PTR" value="-1" required>
                </div>
            </div>
            <div class="col-md-6">
            ...
            <div class="col-md-3">
                <div>
                    <input type="text" class="form-control" name="DS" id="DS" value="-1" required>
                </div>
            </div>
            <div class="col-md-6">
            ...
            <div class="col-md-3">
                <div>
                    <input type="text" class="form-control" name="AAAA" id="AAAA" value="-1" required>
                </div>
            </div>
            <div class="col-md-6">
            ...
            <div class="col-md-3">
                <div>
                    <input type="text" class="form-control" name="CAA" id="CAA" value="-1" required>
                </div>
            </div>
            <div class="col-md-6">
            ...
            <div class="col-md-3">
                <div>
                    <input type="text" class="form-control" name="A" id="A" value="-1" required>
                </div>
            </div>
            <div class="col-md-6">
