{if $smarty.get.connect eq 'none'}
    <div class="alert  alert-danger" style="margin-top: 10px" role="alert">
        Сервер не был добавлен так как к нему не удалось подключится.
        Ошибка: {$smarty.get.error}
    </div>
{/if}
...
<fieldset>
    ...
    <form role="form" id="settings" method="post" class="label-form">
        <div class="row">
            ...
            <div class="col-md-3">
                <div>
                    <input type="text" class="form-control" name="server_name" id="server_name" value="{$name}"
                           required>
                </div>
            </div>
            <div class="col-md-6">
            ...
            <div class="col-md-3">
                <div>
                    <input type="text" class="form-control" name="ip" id="ip" value="{$ip}" required>
                </div>
            </div>
            <div class="col-md-6">
            ...
            <div class="col-md-3">
                <div>
                    <input type="text" class="form-control" name="token" id="token" value="{$token}" required>
                </div>
            </div>
            <div class="col-md-6">
